...
namespace FIMSpace.FProceduralAnimation
{
    public partial class LegsAnimatorEditor
    {
        ...
        protected void View_Extra_Events()
        {
            ...
            sp.Next(false); EditorGUILayout.PropertyField(sp); // Step Prevent
            ...
            if (receiverDetected) { GUILayout.Space(4); EditorGUILayout.LabelField(new GUIContent(FGUI_Resources.Tex_FCorrect, "ILegStepReceiver found" ), GUILayout.Width(20), GUILayout.Height(18)); }
            EditorGUILayout.EndHorizontal();

            if (receiverDetected == false)
            {
