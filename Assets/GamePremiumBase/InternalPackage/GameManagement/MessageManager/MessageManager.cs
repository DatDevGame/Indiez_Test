...
namespace Premium.UI
{
    public class MessageManager : Singleton<MessageManager>
    {
        ...
        {
            Instance.InstanceNotifyEventButtonClicked(clickedEventData);
        }

        public static void Show(bool positiveBtnActive = true, bool negativeBtnActive = false, bool autoHide = true)
        {
            Instance.InstanceShow(positiveBtnActive, negativeBtnActive, autoHide);
        }
        ...
        {
            Instance.InstanceHide(clickedEventData, onHidden);
        }

        public static void ResetPropertiesToDefault()
        {
            Instance.InstanceResetPropertiesToDefault();
        }

        public static RectTransform AddCustomContent(RectTransform content)
        {
            return Instance.InstanceAddCustomContent(content);
        }

        // Non-static methods ============================================================================
        protected virtual void InstanceNotifyEventButtonClicked(ClickedEventData clickedEventData)
        {
        ...
        public virtual void InstanceShow(bool positiveBtnActive = true, bool negativeBtnActive = false, bool autoHide = true)
        {
            isAutoHide = autoHide;
        ...
        public virtual void InstanceHide(ClickedEventData clickedEventData, Action onHidden = null)
        {
            CanvasGroup.interactable = CanvasGroup.blocksRaycasts = false;
        ...
        public virtual void InstanceResetPropertiesToDefault()
        {
        ...
        public virtual RectTransform InstanceAddCustomContent(RectTransform content)
        {
            if (customContent != null)
            {
                Destroy(customContent.gameObject);
