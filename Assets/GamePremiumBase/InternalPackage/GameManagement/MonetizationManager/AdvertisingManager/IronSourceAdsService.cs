...
{
    [OptionalDependency("IronSource", "Premium_IronSource")]
    public class IronSourceAdsService : AbstractMobileAdsService
    {
#if Premium_IronSource
        #region Properties
        [SerializeField] bool isTestSuite = false;
        ...
        string[] _InterstitialParameters,_RewardedParameters;
        #endregion
        ...
        {
            _RewardedParameters = parameters;
            if (IsReadyRewarded)
            {
        ...
        {
            _InterstitialParameters = parameters;
        ...
        void RewardedVideoOnAdOpenedEvent(IronSourceAdInfo adInfo)
        {
            ...
            GameEventHandler.Invoke(AdvertisingEventCode.OnShowAd, AdsType.Rewarded, currentLocation,_RewardedParameters);
        }

        void RewardedVideoOnAdClosedEvent(IronSourceAdInfo adInfo)
        {
            Debug.Log("unity-script: I got RewardedVideoOnAdClosedEvent With AdInfo " + adInfo);
            GameEventHandler.Invoke(AdvertisingEventCode.OnCloseAd, AdsType.Rewarded, currentLocation, true,_RewardedParameters);
        }
        ...
        void RewardedVideoOnAdShowFailedEvent(IronSourceError ironSourceError, IronSourceAdInfo adInfo)
        {
            ...
            GameEventHandler.Invoke(AdvertisingEventCode.OnCloseAd, AdsType.Rewarded, currentLocation, false,_RewardedParameters);
            onFailed?.Invoke();
        }
        ...
        void InterstitialOnAdShowSucceededEvent(IronSourceAdInfo adInfo)
        {
            ...
            GameEventHandler.Invoke(AdvertisingEventCode.OnShowAd, AdsType.Interstitial, currentLocation, _InterstitialParameters);
        }
        ...
        void InterstitialOnAdShowFailedEvent(IronSourceError ironSourceError, IronSourceAdInfo adInfo)
        {
            ...
            GameEventHandler.Invoke(AdvertisingEventCode.OnCloseAd, AdsType.Interstitial, currentLocation, false, _InterstitialParameters);
            onFailed?.Invoke();
        }
        ...
        void InterstitialOnAdClosedEvent(IronSourceAdInfo adInfo)
        {
            ...
            GameEventHandler.Invoke(AdvertisingEventCode.OnCloseAd, AdsType.Interstitial, currentLocation, true, _InterstitialParameters);
            onCompleted?.Invoke();
            if (!IsRemoveAds.value)
            {
                if (Placements.LoadInterstitial && Placements.Interstitial != "") IronSource.Agent.loadInterstitial();
