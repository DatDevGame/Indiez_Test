...
namespace Premium.Monetization
{
    public class EditorAdsService : AbstractAdsService
    {
        ...
        {
            GameEventHandler.Invoke(AdvertisingEventCode.OnShowAd, AdsType.Rewarded, location, parameters);
            if (isSimulateAdsBehaviour)
            {
                ...
                if (rewardedAdsIsReady)
                {
                    ...
                    void RewardedAdSuccessBtnClicked()
                    {
                        ...
                        GameEventHandler.Invoke(AdvertisingEventCode.OnCloseAd, AdsType.Rewarded, location, true, parameters);
                    }
                    ...
                    void RewardedAdFailBtnClicked()
                    {
                        ...
                        rewardedAdSuccessBtn.onClick.RemoveListener(RewardedAdSuccessBtnClicked);
                        rewardedFailBtn.onClick.RemoveListener(RewardedAdFailBtnClicked);
                        GameEventHandler.Invoke(AdvertisingEventCode.OnCloseAd, AdsType.Rewarded, location, false, parameters);
                    }
                }
            }
            else
