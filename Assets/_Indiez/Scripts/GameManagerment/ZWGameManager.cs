...
namespace Premium.GameManagement
{
    ...
    /// </summary>
    public class ZWGameManager : Singleton<ZWGameManager>
    {
        private const string k_DebugTag = nameof(ZWGameManager);
        private const string k_GameManagerName = "ZWGameManager";
